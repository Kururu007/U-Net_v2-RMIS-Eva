...
from PolypSeg.unet_v2.pvtv2 import *
...
if __name__ == "__main__":
    pretrained_path = "./PolypSeg/pvt_pth/pvt_v2_b2.pth"
    model = UNetV2(n_classes=2, deep_supervision=True, pretrained_path=None).cuda()
